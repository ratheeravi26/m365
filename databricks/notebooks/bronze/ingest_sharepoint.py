...
# MAGIC %md
# MAGIC ### Bronze ingestion – SharePoint datasets
# MAGIC
# MAGIC This notebook ingests the SharePoint-specific Microsoft Graph Data Connect datasets
# MAGIC (Sites, Permissions, Groups) into the bronze Delta layer. It is intended to be executed
# MAGIC independently or orchestrated by the parent bronze pipeline notebook.
...
DATASET_CONFIG: List[Dict[str, str]] = [
    {
        "dataset_name": "SharePointSites_v1",
        "output_alias": "sharepoint_sites",
        "partition_key": "snapshot_date",
    },
    {
        "dataset_name": "SharePointPermissions_v1",
        "output_alias": "sharepoint_permissions",
        "partition_key": "snapshot_date",
    },
    {
        "dataset_name": "SharePointGroups_v1",
